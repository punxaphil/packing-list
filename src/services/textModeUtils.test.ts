...
import { expectCallsToThese } from './testUtils.ts';
...
`;
  ...
  describe('updateFirebaseFromTextPackItems', () => {
    it('should delete removed pack items', async () => {
      ...
      expectCallsToThese(firebase.deletePackItem);
    });
    ...
    it('should update existing pack items', async () => {
      ...
      expectCallsToThese(firebase.updatePackItem);
    });
    ...
    it('should update existing pack items because category changed', async () => {
      ...
      expectCallsToThese(firebase.updatePackItem, firebase.addCategory);
    });
    ...
    it('should add new pack items', async () => {
      ...
      expectCallsToThese(firebase.addPackItem);
    });
